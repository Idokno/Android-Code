package com.example.newnewnode;

import java.util.ArrayList;
import java.util.Calendar;
import java.util.HashMap;

import com.example.newnewnode.sqlite.DatabaseHelper;
import com.example.newnewnode.sqlite.SQLiteUtils;
...
public class EditActivity extends Activity{
    ...
    private Button backButton,timeSetButton,myButton;
